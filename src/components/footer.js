...
import { faTwitter, faInstagram, faFacebook, faGoodreads, faYoutube } from '@fortawesome/fontawesome-free-brands'
            ...
            <footer className="footer-section">
                <div className="footer-container footer-grid">
                    <div className="footer-child footer-paragraph-info">
                        ...
                        <p>
                            Hadar Shmaryahu Ya'akov loves to hear from readers. You can reach him via email.
                        ...
                        <nav className="social-media-nav">
                            <ul>
                                ...
                                <li>
                                    <a
                                        target="_blank"
                                        href="https://www.goodreads.com/book/show/54900581-the-sailor-and-the-sermon"
                                        rel="noreferrer"
                                    >
